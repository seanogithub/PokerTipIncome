...
public class UI_ButtonColorPicker : MonoBehaviour {
	...
	{
//		style2XButtonBlue.normal.textColor = UserBlobManager.GetComponent<UserBlobManager>().ButtonColor;
//		ColorPicked = UserBlobManager.GetComponent<UserBlobManager>().ButtonColor;
		Enabled = myValue;
...
//				print (ColorPicked.ToString());
			...
			{
				UserBlobManager.GetComponent<UserBlobManager>().ButtonColor = ColorPicked;
