...
public class UI_PickerSkin : MonoBehaviour {
...
*/	
	void OnGUI()
	{
		if (Enabled == true)
		{
			...
			this.pickerParams[0].column = new string[3];
			this.pickerParams[0].column[0] = "iOS7"; 
			this.pickerParams[0].column[1] = "Vintage"; 
			this.pickerParams[0].column[2] = "Money"; 
